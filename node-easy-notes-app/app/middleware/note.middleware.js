module.exports = (req, res, next) => {
    ...
    if(!pattern.test(req.body.content)){
        return res.status(400).send({
            message: "Content should begin with alphabets and can contain only alphanumeric values and should be minimum of length 3",
        });
    } else {
        next();
    }
